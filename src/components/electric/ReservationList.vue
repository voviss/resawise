<template>
    <div>
      ...
      <table>
        ...
        <tbody>
          <tr v-for="(reservation) in reservations.filter(l => l.type === 'electric')" :key="reservation.id">
      ...
      <table>
        ...
        <tbody>
          <tr v-for="reservation in waitingList.filter(l => l.type === 'electric')" :key="reservation.id">
            <td>{{ reservation.id }}</td>
            <td>{{ reservation.name }}</td>
            <td>{{ reservation.date }}</td>
            <td>{{ reservation.timeSlot }}</td>
